...
PROJECT="org.kde.fanspeedMonitor"
...
sed -e "s,Report-Msgid-Bugs-To: http://bugs.kde.org,Report-Msgid-Bugs-To: https://github.com/dwardor/plasma-applet-fanspeed-monitor/issues," -i "po/$NAME.pot"
